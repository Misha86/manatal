...
from src.core.jinja2.cache import RedisBytecodeCache
from src.core.jinja2.loaders import S3TemplateLoader
...
jinja2_env: Environment = Environment(
    loader=S3TemplateLoader("animal-runway", "templates"),
