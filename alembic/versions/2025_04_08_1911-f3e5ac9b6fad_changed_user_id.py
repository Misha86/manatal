...
Revision ID: f3e5ac9b6fad
Revises: 
Create Date: 2025-04-08 19:11:31.132660
...
def upgrade() -> None:
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['career_page_id'], ['career_page.id'], ondelete='CASCADE'),
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['external_job_post_id'], ['external_job_post.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['job_post_id'], ['job_post.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('job_post_id', 'external_job_post_id', name='uq_job_post_link')
    )
